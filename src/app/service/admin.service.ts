...
*/
  ...
  */
  ...
  addNewSlider(sliderdata: any ): Observable<any> {
    return this.http.post(apiUrl + 'admin/addnewslider', sliderdata, httpOptions )
      .pipe(
        map(this.extractData),
        catchError(this.handleError)
      );
  ...
  getSlideritems(): Observable<any> {
    return this.http.get( apiUrl + 'admin/slideritems/',  httpOptions )
      .pipe(
        map(this.extractData),
        catchError(this.handleError)
      );
  }
  deleteslideritem(sliderid: string): Observable<any> {
    return this.http
      .delete(apiUrl + 'admin/slider/' + sliderid, httpOptions)
      .pipe(
        map(this.extractData),
        catchError(this.handleError)
      );
