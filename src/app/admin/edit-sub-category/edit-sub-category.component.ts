...
export class EditSubCategoryComponent implements OnInit {
 ...
 fieldbuttons: Array<String> = ['Name', 'Amount for sale', 'Type of Unit', 'Price per unit', 'Price Negotiable', 'Currency', 'Description', 'status', 'Year of manufacture',  'Condition', 'Addition Information', 'Manufacture'];
 // tslint:disable-next-line:max-line-length
 copyfieldbuttons: Array<String> = ['Name', 'Amount for sale', 'Type of Unit', 'Price per unit', 'Price Negotiable', 'Currency', 'Description', 'status', 'Year of manufacture', 'Condition', 'Addition Information', 'Manufacture'];
 // tslint:disable-next-line:max-line-length
 formkey: Array<String> = ['name', 'amountforsale', 'amountunit', 'priceperunit', 'pricenegotiable', 'currency', 'description', 'status', 'yearmfg', 'condition', 'addinfo', 'manufacture' ];
