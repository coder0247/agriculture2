...
@Component({
  selector: 'app-makebestseller',
  templateUrl: './makebestseller.component.html',
  styleUrls: ['./makebestseller.component.css']
})
export class MakebestsellerComponent implements OnInit {
