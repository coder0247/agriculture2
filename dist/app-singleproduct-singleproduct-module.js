    ...
    ProductComponent.prototype.ngOnInit = function () {
        ...
        this.utils.getClientIPAddress().subscribe(function (res) {
            ...
            _this.route.params.subscribe(function (params) {
                ...
                _this.product
                    .saveProductViewedStatus(params['id'], _this.clientIP)
        ...
        if (userid) {
            this.route.params.subscribe(function (params) {
                _this.product.getSellerByProductID(params['id']).subscribe(function (res) {
                    if (res['status'] === 'success') {
                        _this.showloading = false;
                        var seller = res.data.sellerinfo[0];
                        _this.showsellerDetails = true;
                        _this.sellerdetails.name =
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.product.getProductDetail(params['id']).subscribe(function (res) {
                if (res['status'] === 'success') {
                    _this.showloading = false;
